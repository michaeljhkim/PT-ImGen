...
/*
- 3D Vector Type that is used to represent coordinates in a 3D space
- For the most part, these are all pretty explanatory
*/
...
int random_int(int min, int max) {
    return min + static_cast<int>((max - min + 1) * random_float());
}
...
public:
    ...
    float length_squared() const { return m_x*m_x + m_y*m_y + m_z*m_z; }
